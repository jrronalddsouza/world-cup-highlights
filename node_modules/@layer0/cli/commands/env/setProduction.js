...
exports.handler = async yargs => {
  ...
  if (!config) {
    context.logger.error(`Error: layer0.config.js not found. Please run "0 init" to initialize your Layer0 project.\n`);
    process.exit(1);
  }

  const packageJson = Layer0PackageJson.loadPackageJson(pathParam);
  const siteSlug = siteSlugParam || config.name || packageJson.name;
