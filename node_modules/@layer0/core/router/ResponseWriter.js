            ...
            await this.setCreateResponseAction(async () => {
                ...
                try {
                    ...
                    if (transformResponse) {
                        ...
                        // We need to recalculate the actual content-length size when the app is running in development mode
                        // as the transformResponse function may change the response size, adaptResponseEncodingToDownstream is not used in this mode
                        // and development express server doesn't support compression
                        if (!environment_1.isCloud()) {
                            this.internalSetResponseHeader(constants_1.HTTP_HEADERS.contentLength, Buffer.byteLength((_b = (_a = this.response.body) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '', 'utf8').toString(), false, this.postCacheResponseActions);
                        }
                    }
                }
                catch (e) {
